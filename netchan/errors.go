...
var (
	...
	ErrMarshalerChanEncoder    error = newErrMarshaler("netchan: marshaler chan encoder not set")
	ErrMarshalerChanDecoder    error = newErrMarshaler("netchan: marshaler chan decoder not set")
